...
/* Mangle symbol names to avoid symbol collisions with other ELF objects. */
	#define gbr_find_exe         bLbr25538419688844_gbr_find_exe
	#define gbr_find_exe_dir     bLbr25538419688844_gbr_find_exe_dir
	#define gbr_find_prefix      bLbr25538419688844_gbr_find_prefix
	#define gbr_find_bin_dir     bLbr25538419688844_gbr_find_bin_dir
	#define gbr_find_sbin_dir    bLbr25538419688844_gbr_find_sbin_dir
	#define gbr_find_data_dir    bLbr25538419688844_gbr_find_data_dir
	#define gbr_find_locale_dir  bLbr25538419688844_gbr_find_locale_dir
	#define gbr_find_lib_dir     bLbr25538419688844_gbr_find_lib_dir
	#define gbr_find_libexec_dir bLbr25538419688844_gbr_find_libexec_dir
	#define gbr_find_etc_dir     bLbr25538419688844_gbr_find_etc_dir
