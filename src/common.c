...
alltray_common_bug_detected() {
  g_error(
"%s has encountered a programming error (a bug) and cannot continue.\n"
...
"system and hardware platform you are running on); this can help discovering\n"
"and eliminating the bug easier.\n", PACKAGE_NAME, PACKAGE_BUGREPORT);
}
